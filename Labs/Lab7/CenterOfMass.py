...
# of a given galaxy and simulation snapshot
    ...
    def COM_P(self, delta):
        ...
        while (change > delta):
            ...
            # write your own code below
            x_new = self.x - x_COM2 # this is the new z using the index2
            y_new = self.y - y_COM2 # this is the new z
            z_new = self.z - z_COM2 # this is the new z
    ...
    def COM_V(self, x_COM, y_COM, z_COM):
        ...
        xV = self.x*u.kpc - x_COM # need to make sure postion has correct units 
